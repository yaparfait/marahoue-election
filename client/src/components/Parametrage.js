...
function Parametrage() {
    ...
    const items = [{ label: 'Application' }, { label: 'Paramétrage' }];
            ...
            <div class="grid">
                ...
                <div class="col">
                    ...
                    <div className="col-12 p-4 text-center md:text-left flex align-items-center surface-0 text-800">
                        <section>
                            <span className="block text-6xl text-primary font-bold mb-1">Paramétrage des éléments de référence</span>
                            <p className="mt-0 mb-4 text-700 line-height-3">Creation, modification et suppression des Départements, des Communes/Sous-Prefectures, des Lieux de vote, des Partis Politiques, des Candidats, des Scrutions et des Comptes Utilisateurs</p>
                        </section>
                    </div>
                </div>
            </div>
